  ...
  return (
    <section className="w-full bg-white px-4 py-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#A7D7D9] to-[#BFE7D2] p-6 md:p-12">
          ...
          <div className="relative z-10 flex flex-col gap-10 md:flex-row md:items-center">
            ...
            <div className="max-w-lg md:pl-2">
          ...
          <div className="pointer-events-none absolute -right-40 -top-28 h-[560px] w-[560px] rounded-full bg-white md:h-[640px] md:w-[640px]" />
          ...
          <img
            ...
            className="
              ...
              md:h-[520px]
              md:translate-x-24 md:translate-y-16
            "
          />
        </div>
      </div>
